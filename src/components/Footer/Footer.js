...
const Footer = () => {
    return (
        ...
        <a href='https://www.linkedin.com/in/sumaiya-nawsheen/' target='_blank' rel="noreferrer"><FontAwesomeIcon style={footerStyle} icon={faLinkedinIn} className='icons-style fa-3x'/></a>
